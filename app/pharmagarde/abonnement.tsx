...
const styles = StyleSheet.create({
  ...
  heroCard: { borderRadius: 16, padding: 18, backgroundColor: "#102016", overflow: "hidden", shadowColor: "#092A13", shadowOpacity: 0.08, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  ...
  card: { marginTop: 16, borderRadius: 12, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#D6EBDD", padding: 16, gap: 12, shadowColor: "#092A13", shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  ...
  button: { minHeight: 52, borderRadius: 10, backgroundColor: BRAND_GREEN, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 9, marginTop: 16 },
