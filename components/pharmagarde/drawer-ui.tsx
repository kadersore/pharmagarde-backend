...
const styles = StyleSheet.create({
  hero: { margin: 16, marginBottom: 10, padding: 16, borderRadius: 28, backgroundColor: BRAND_GREEN, flexDirection: "row", alignItems: "center", gap: 12, shadowColor: "#062F16", shadowOpacity: 0.16, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 5 },
  heroIcon: { width: 50, height: 50, borderRadius: 25, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.2)", borderWidth: 1, borderColor: "rgba(255,255,255,0.35)" },
  heroText: { flex: 1 },
  ...
  closeButton: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" },
  ...
  sectionCard: { borderRadius: 26, backgroundColor: SURFACE, borderWidth: 1, borderColor: BORDER, overflow: "hidden" },
  ...
  rowIcon: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: "#EAF8EF" },
  ...
  segment: { minHeight: 36, minWidth: 78, paddingHorizontal: 13, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: "#F6FBF8", borderWidth: 1, borderColor: BORDER },
  ...
  footer: { margin: 16, marginTop: 18, padding: 16, borderRadius: 24, backgroundColor: "#EAF8EF", borderWidth: 1, borderColor: BORDER, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10 },
  footerText: { flex: 1, color: MUTED, fontSize: 12, lineHeight: 17, fontWeight: "700" },
  footerBadge: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 999, backgroundColor: "#FFFFFF" },
